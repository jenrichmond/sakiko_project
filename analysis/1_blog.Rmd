...
I also learned how to add error bars to column graphs, making sure to specify its width, so doesn't look ugly. 
...
To complete next week's coding exercise, I still need to learn how to make scatterplots. I'll learn this by watching [this video](https://www.youtube.com/watch?v=Ouoinu4ScPs&feature=emb_logo&ab_channel=RLadiesSydney) from the RYouWithMe resource.
